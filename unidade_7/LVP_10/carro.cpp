...
carro::carro(string tipoVeiculoCR, string modeloVeiculoCR,int anoFabricacao, int numeroChassi ,int preco){
    this->tipoVeiculoCR=tipoVeiculoCR;
    this->modeloVeiculoCR=modeloVeiculoCR;

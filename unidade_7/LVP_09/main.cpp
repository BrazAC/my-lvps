...
> Descrição: Faça um programa que simule uma concessionária que venda carros e caminhões. É importante que tenha uma herança entre classes. 
A herança será definida por uma classe base (Veículo) que terá como atributos o ano de fabricação, o número do chassi e o preço.
*/
#include <iostream>
#include <algorithm>
#include <vector>
